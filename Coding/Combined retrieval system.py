...
# Function to retrieve top 10 documents based on combined scores
...
# Define equal weights for TF-IDF, BM25, and Embedding
weights = {'tfidf': 1/3, 'bm25': 1/3, 'embedding': 1/3}

# Calculate MAP for combined TF-IDF + BM25 + Embedding
...
print(f"Mean Average Precision (MAP) for Combined TF-IDF + BM25 + Embedding (Equal Weights): {map_score:.4f}")
